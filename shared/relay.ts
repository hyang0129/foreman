...
const routes: Record<string, readonly string[]> = {
  GET: ['/api/launch', '/api/projects', '/api/models', '/api/health', '/api/host', '/api/sessions', '/api/session', '/api/session/tail', '/api/pm/history', '/api/memory'],
  POST: ['/api/launch/propose', '/api/launch/cancel', '/api/projects/resolve', '/api/projects/register', '/api/projects/update', '/api/projects/remove', '/api/pm/model', '/api/sessions', '/api/session/message', '/api/session/interrupt', '/api/session/approval', '/api/pm/message', '/api/pm/interrupt'],
};
