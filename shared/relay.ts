...
const routes: Record<string, readonly string[]> = {
  GET: ['/api/models', '/api/health', '/api/host', '/api/sessions', '/api/session', '/api/session/tail', '/api/pm/history', '/api/memory'],
  POST: ['/api/pm/model', '/api/sessions', '/api/session/message', '/api/session/interrupt', '/api/session/approval', '/api/pm/message', '/api/pm/interrupt'],
};
