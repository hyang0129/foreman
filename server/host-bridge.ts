...
export function startHostBridge(port: number, localToken?: string, options: Omit<HostBridgeOptions, 'localToken'> = {}): { close(): void; notify?: (frame: NotifyFrame) => void; bridge?: HostBridge } {
  try {
